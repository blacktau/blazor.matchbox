namespace Blazor.Matchbox.Tests.IntersectionObserverAPI
{
    ...
    {
        private const string Create = "BlazorMatchbox.IntersectionObserverManager.create";
        private const string TakeRecords = "BlazorMatchbox.IntersectionObserverManager.takeRecords";
        private const string Disconnect = "BlazorMatchbox.IntersectionObserverManager.disconnect";
        private const string Observe = "BlazorMatchbox.IntersectionObserverManager.observe";
        private const string Unobserve = "BlazorMatchbox.IntersectionObserverManager.unobserve";
        private const string Dispose = "BlazorMatchbox.IntersectionObserverManager.dispose";
