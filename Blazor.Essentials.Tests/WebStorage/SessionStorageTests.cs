namespace Blazor.Essentials.Tests.WebStorage
{
    using System;
    ...
    {
        private const string Length = "BlazorEssentials.SessionStorageProxy.getLength";
        private const string Key = "BlazorEssentials.SessionStorageProxy.key";
        private const string GetItem = "BlazorEssentials.SessionStorageProxy.getItem";
        private const string SetItem = "BlazorEssentials.SessionStorageProxy.setItem";
        private const string RemoveItem = "BlazorEssentials.SessionStorageProxy.removeItem";
        private const string Clear = "BlazorEssentials.SessionStorageProxy.clear";
