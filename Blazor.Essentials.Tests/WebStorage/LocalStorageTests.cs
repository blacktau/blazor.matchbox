namespace Blazor.Essentials.Tests.WebStorage
{
    ...
    {
        private const string Length = "BlazorEssentials.LocalStorageProxy.getLength";
        private const string Key = "BlazorEssentials.LocalStorageProxy.key";
        private const string GetItem = "BlazorEssentials.LocalStorageProxy.getItem";
        private const string SetItem = "BlazorEssentials.LocalStorageProxy.setItem";
        private const string RemoveItem = "BlazorEssentials.LocalStorageProxy.removeItem";
        private const string Clear = "BlazorEssentials.LocalStorageProxy.clear";
